...
export function SiteFooter({ className }: React.HTMLAttributes<HTMLElement>) {
  return (
    <footer className={cn(className)}>
      <p className="text-md  text-white/70 p-2 text-center -mt-2 md:m-0">As it is imperative to build community, a percentage of net profit will be donated to philanthropy at our
        discretion.</p>
