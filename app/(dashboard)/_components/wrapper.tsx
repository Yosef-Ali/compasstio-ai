...
const Wrapper: React.FC<WrapperProps> = ({ children }) => {
  ...
  return (
    <main className={cn(asideWidth, `${isMobile && isSlideOut ? 'w-0' : 'w-full'} h-full overflow-hidden transition-width duration-500`)}>
      <div className="h-full w-full flex-col relative z-20">
        {children}
      </div>
