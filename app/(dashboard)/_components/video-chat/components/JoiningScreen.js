...
export function JoiningScreen({
  ...
  useEffect(() => {
    getDevices({ micEnabled: false, webcamEnabled: false });
  }, []);
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {!isXSOnly && (
                    <Box
                      className="absolute md:left-52 lg:left-24 xl:left-44 md:right-52 lg:right-24 xl:right-44  cursor-pointer bg-gray-700"
                      style={{
                        position: "absolute",
                        display: "flex",
                        alignItems: "center",
