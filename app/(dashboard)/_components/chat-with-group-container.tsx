...
const Intro = () => {
  return (
    <div className="mx-auto w-full z-0 w-sm md:max-w-md lg:max-w-lg px-4  py-12 lg:py-24 flex flex-col stretch space-y-10 text-center transition-width duration-500">
