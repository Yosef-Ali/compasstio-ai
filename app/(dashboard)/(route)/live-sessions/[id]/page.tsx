...
import JoinScreen from "@/app/(dashboard)/_components/live-streaming/join-screen";
import VideoComponent from "@/app/(dashboard)/_components/live-streaming/video-component";
