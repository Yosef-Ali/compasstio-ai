              ...
              <div>
                ...
                <div className="hidden pr-6 md:block">
                  <div className="w-full">
                    <button data-testid="upgrade-button" aria-label="Upgrade to Pro" className="focus:outline-none flex select-none items-center py-3 text-xs font-medium ring-offset-2 focus:ring-2 text-white justify-center rounded-lg bg-purple-500 hover:bg-purple-700 w-full px-5">
